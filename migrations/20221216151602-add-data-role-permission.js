...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    INSERT INTO "roles_permissions" (id, role_id, permission_id, is_system, created_at, updated_at) VALUES
      ...
      (13, 1, 13, true,  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (14, 1, 14, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (15, 1, 15, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
      (16, 1, 16, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
